...
// This class will be used to showcase static and instance features
// of a class, to then be loaded in the staticdriver and can see priority
// in terms of memory ordering and execution. 
